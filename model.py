...
class MIOSTONELayer(nn.Module):
    ...
    def _init_layer(self):
        ...
        # Normalization layer to be tuned during TTA
        # LayerNorm is used so that even the first layer has normalization
    ...
    def forward(self, x, x_linear):
        ...
        # Apply layer normalization so each layer (including the first) has its own norm
        x_norm = self.layer_norm(x_gated)
